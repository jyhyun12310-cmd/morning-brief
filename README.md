...
매일 아침 7시(KST), 전일 미국장 핵심 이슈와 금일 한국장 방향을 카드 한 장으로 만들어
**카카오톡 나에게 보내기**와 **인스타그램**에 자동 발송합니다.

```
07:00 KST  →  데이터 수집  →  Claude 요약  →  카드 JPEG 생성
                                                   ↓
                              GitHub Pages 업로드 → 카톡 + 인스타 발송
```
...
**MSCI 한국지수 야간선물은 안 들어갑니다.** 무료로 받을 방법이 없어서 뉴욕에 상장된
한국 ETF(EWY)를 대체 지표로 씁니다. 방향성은 상당히 잘 따라갑니다.
